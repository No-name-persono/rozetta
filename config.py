...
DEFAULTS = {
    ...
    "SPECTRAL_STT_GUIDED_ENABLED": os.getenv("SPECTRAL_STT_GUIDED_ENABLED", "1") in {"1", "true", "True"},
    "SPECTRAL_STT_MAX_GAP_SEC": float(os.getenv("SPECTRAL_STT_MAX_GAP_SEC", "0.8")),
    "SPECTRAL_STT_PADDING_SEC": float(os.getenv("SPECTRAL_STT_PADDING_SEC", "0.2")),
